  ...
  <header class="app-header">
    <div class="container">
      ...
      <nav class="navigation">
        ...
        <router-link v-if="isLoggedIn" to="/reviews" class="nav-link">Reviews</router-link>
        ...
        <div v-if="isLoggedIn" class="profile-dropdown">
          ...
          <div v-if="showDropdown" class="dropdown-menu">
            ...
            <router-link to="/reviews" class="dropdown-item">My Reviews</router-link>
        ...
        <div v-if="isAdmin" class="admin-panel-dropdown">
          ...
          <div v-if="showAdminPanel" class="admin-panel-menu">
            ...
            <router-link to="/admin/management" class="admin-panel-item">Admin Management</router-link>
